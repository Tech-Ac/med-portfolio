...
export default function AnalyticsPage() {
  return (
    <div>
      ...
      <p className="text-sm text-muted-foreground mb-10">View site analytics. Connect Vercel Analytics or PostHog.</p>

      <div className="border border-dashed border-border bg-background p-12 text-center">
        <p className="font-display text-xl mb-3">Analytics Management</p>
        ...
        <div className="mt-12 text-left max-w-3xl mx-auto border border-border">
          ...
          <div className="divide-y divide-border">
            <div className="grid grid-cols-4 gap-4 p-4 text-sm"><span>Analytics Example</span><span><span className="px-2 py-1 bg-green-50 text-green-700 text-xs">Published</span></span><span className="text-muted-foreground">Dec 2024</span><span className="text-muted-foreground">Edit — Delete</span></div>
            <div className="grid grid-cols-4 gap-4 p-4 text-sm"><span>Analytics Draft</span><span><span className="px-2 py-1 bg-yellow-50 text-yellow-700 text-xs">Draft</span></span><span className="text-muted-foreground">Dec 2024</span><span className="text-muted-foreground">Edit — Delete</span></div>
          </div>
        </div>
      </div>
    </div>
